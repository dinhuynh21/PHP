...
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="panel-body">
                ...
                ?>
                <div class="form" >
                    <form class="cmxform form-horizontal " id="signupForm" action="{{ URL::to('/save-phongban')}}" novalidate="novalidate" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-3 col-lg-6">
                                <button class="btn btn-primary" name="" type="submit">Thêm</button>
